...
define('LOG_FILE', __DIR__ . '/logs/obtener_datos_clientes_sucursal.log');
...
function obtenerDatosClientesSucursal()
{
    try {
        if (!verifyToken()) {
        ...
        // Obtener todos los clientes de la sucursal con los campos sincronizables
        // Se retornan todos los registros de la sucursal para que Access actualice
        // los campos disponibles. Access solo sobreescribirá valores no nulos.
        $stmt = $pdo->prepare("
            SELECT
                membresia,
                nombre,
        ...
        logMessage("SUCCESS: Consulta datos completos - Sucursal: $sucursal, Registros: " . count($datos));
