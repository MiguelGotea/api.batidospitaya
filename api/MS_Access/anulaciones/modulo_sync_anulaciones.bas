...
Public Function SyncEnviarAnulacionesPendientes() As Boolean
    ...
    sAnulUrlEnviar = "https://proxy.batidospitaya.com/api/MS_Access/anulaciones/sync_anulacion_pedidos.php"
...
Public Function SyncLeerRespuestasAnulacion() As Boolean
    ...
    sAnulUrlLeer = "https://proxy.batidospitaya.com/api/MS_Access/anulaciones/read_anulacion_pedidos.php"
...
Private Sub ConfirmarEjecucionEnHost(lngCodPedido As Long, codSuc As String)
    ...
    sAnulUrlConfirm = "https://proxy.batidospitaya.com/api/MS_Access/anulaciones/confirm_anulacion_pedidos.php"
...
Public Function SyncAnularCierresPendientes() As Boolean
    ...
    sUrlLeer = "https://proxy.batidospitaya.com/api/MS_Access/anulaciones/read_anulacion_cierres_diarios.php"
    ...
    If cantProcesados > 0 Then
        ...
        sUrlConfirm = "https://proxy.batidospitaya.com/api/MS_Access/anulaciones/confirm_anulacion_cierres_diarios.php"
