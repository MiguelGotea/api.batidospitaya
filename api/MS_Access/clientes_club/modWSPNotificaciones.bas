...
Public Sub enviarnotificacionclienteusopuntos(ByVal membresia As String, ByVal puntos As Integer, ByVal sucursal As String)
    ...
    Const API_URL As String = "https://proxy.batidospitaya.com/api/MS_Access/clientes_club/notificacion_puntos.php"

    ' Crear objeto HTTP (Late Binding - ServerXMLHTTP para evitar bloqueos)
