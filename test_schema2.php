...
try {
    ...
    echo "1. session fetched: " . ($sesion['numero_telefono'] ?? '0') . "\n";
    ...
    $stmtConv->execute([':inst' => 'wsp-crmbot', ':nc' => '5055741601999']);
    $conv = $stmtConv->fetch();
    ...
    $stmtInsert = $conn->prepare("
        ...
        VALUES
            (:inst, :nc, :nr, 'bot', NULL,
             ...
             CONVERT_TZ(NOW(),'+00:00','-06:00'))
    ");
    $stmtInsert->execute([':inst' => 'wsp-crmbot', ':nc' => '5055741601999', ':nr' => '0000']);
